<template>
  <div id="paramPage" @click="showYear = false;showSearch = false">
                  ...
                  <table style="table-layout:fixed;">
                    ...
                    <tbody v-if="list.length > 0">
                      <tr v-for="(item,index) in list" :key="index">
                        ...
                        <td>
                          <span class="main-font">{{item.publisher_id}}</span>
                        </td>
                        <td>
                          <span class="main-font">{{item.publisher_name}}</span>
                        </td>
    ...
    <a-modal
      v-model="addParam"
      width="600px"
      :title="paramType == 1?'新增出版社系数配置':'修改出版社系数配置'"
      on-ok="handleOk"
      @cancel="close"
    >
      ...
      <div class="popup" @click="showYear = false">
        <div class="option">
          ...
          <div class="normal" v-else>{{addInfo.publisher_name}}</div>
        </div>
...
export default {
  ...
  methods: {
    ...
    addParamSet() {
      this.paramType = 1;
      this.addInfo.publisher_id = 0;
      this.addInfo.publisher_name = "";
      this.publisherName = "";
      this.addInfo.ratio = "";
      this.addInfo.year = "";
    ...
    setParam(item, index) {
      this.paramType = 2;
      this.addInfo.publisher_name = item.publisher_name;
      this.addInfo.publisher_id = item.publisher_id;
    ...
    selected(value) {
      this.dataSource.map((val, key) => {
        if (val.publisher_name == value) {
          this.addInfo.publisher_id = val.publisher_id;
          this.addInfo.publisher_name = val.publisher_name;
        }
      });
      this.getCurrenData();
    ...
    openRead(item, index) {
      this.recordInfo.publisher_id = item.publisher_id;
      this.recordInfo.publisher_name = item.publisher_name;
    ...
    selectSearch(litem, lindex) {
      console.log(111);
      this.inputVal = litem.publisher_name;
      this.searchId = litem.publisher_id;
    }
  }
};
</script>
