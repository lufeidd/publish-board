...
export const MYCATE_GOODS = query => req('post', '/mycate/goods', query);
...
export const MYAUTHOR_HISTORY = query => req('post', '/myauthor/history', query);
export const MYAUTHOR_SEARCH = query => req('post', '/myauthor/search', query);
