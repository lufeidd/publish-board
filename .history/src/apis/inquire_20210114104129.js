...
// 页面访问数据
export const VISITDATA_PAGE = query => req('post', '/visitdata/page', query);
// 用户访问数据
export const VISITDATA_USER = query => req('post', '/visitdata/user', query);
// 商品查询
export const QUERY_GOODS_SEARCH = query => req('post', '/query/goods/search', query);