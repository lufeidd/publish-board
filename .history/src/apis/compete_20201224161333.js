...
// 竞社品种对比列表
export const COMPETE_MONITOR_PUBLISHER_GOODS = query => req('post', '/compete/monitor/supplier/goods', query);
// 竞社类目对比列表
export const COMPETE_MONITOR_PUBLISHER_CATEGORY = query => req('post', '/compete/monitor/supplier/category', query);
// 竞社类目对比列表
export const COMPETE_MONITOR_PUBLISHER_CATEGORY = query => req('post', '/compete/monitor/supplier/region', query);