      ...
      <div class="clearfix">
        ...
        <div class="float-right">
          <div class="main-container" v-if="powerType == 1">
            ...
            <div class="model-container">
              <div class="model-bg" style="min-height: 600px;position:relative;padding-bottom:75px;">
                  ...
                  <table style="table-layout: fixed">
                    ...
                    <tbody v-if="userList.length > 0">
                      <tr v-for="(item,index) in userList" :key="index">
                        ...
                        <td style="text-align: right">
                            <span v-if="item.most_view">{{item.most_view}}</span>
                            <span v-else>--</span>
                        </td>
                        <td style="text-align: right">
                            <div>
                ...
                <!-- 分页 -->
                <div v-if="tabKey == '2'" style="position:absolute;right:15px;bottom:15px;">
                  <a-pagination
