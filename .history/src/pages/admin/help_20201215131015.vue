                    ...
                    <tbody v-if="list.length > 0">
                      <tr v-for="(item,index) in list" :key="index">
                        ...
                        <td style="text-align:center;">
                          ...
                          <span class="main-font" v-if="item.logo_id == 2">读者huax</span>
                          <span class="main-font" v-if="item.logo_id == 3">竞争</span>
                          <span class="main-font" v-if="item.logo_id == 4">行业</span>
        ...
        <div class="option">
          ...
          <div class="normal">
            <a-radio-group name="radioGroup" v-model="eventInfo.type" size="small">
              ...
              <a-radio :value="2">本社</a-radio>
              <a-radio :value="3">竞争</a-radio>
