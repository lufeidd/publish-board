                    ...
                    <tbody v-if="list.length == 0">
                      <tr v-for="(item,index) in list" :key="index">
                        ...
                        <td style="text-align:center;">
                          <span class="main-font" v-if="item.logo_id == 1">读者画像</span>
                          <span class="main-font" v-if="item.logo_id == 2">新品追踪</span>
                          <span class="main-font" v-if="item.logo_id == 3">基本定义</span>
                        </td>
                        <td>
                          <div class="author">
        ...
        <div class="option">
          ...
          <div class="normal">
            <a-radio-group name="radioGroup" v-model="eventInfo.type" size="small">
              <a-radio :value="1">读者画像</a-radio>
              <a-radio :value="2">新品追踪</a-radio>
              <a-radio :value="3">基本定义</a-radio>
