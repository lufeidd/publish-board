  ...
  <div id="organizePage">
              ...
              >
                <div class="section-title clearfix">
                  <span class="float-left"
                    >{{ organization_name }} 成员列表</span
                  >
                  <span class="float-right click-font" @click="showModal"
                    >添加成员</span
                  >
                </div>
                <div class="search">
                    ...
                    <tbody v-else>
                      <tr>
                        <td colspan="7" style="text-align: center">
                          <div style="margin-top:100p"><a-empty /></div>
                        </td>
                      </tr>
                    </tbody>
                  </table>
      ...
      <template slot="footer">
        <div class="clearfix">
          ...
          <div class="float-right">
            ...
            <a-button @click="addAdmin">添加为管理员</a-button>
            <a-button
              key="submit"
              type="primary"
              @click="handleOk"
              ...
              >
                <div class="result">
                  ...
                  <img
                    ...
                    v-else-if="opt.pic == 6"
                  />
                  <span v-else class="no-pic" style="min-width:20px;min-height:20px;border-radius:50%;"></span>
          ...
          <div class="content">
            ...
            >
              ...
              <img
                ...
                alt
                style="width:20px;height:20px;"
                v-else-if="item.pic == 2"
              />
              <img
                src="../../assets/user3.png"
                alt
                style="width:20px;height:20px;"
                v-else-if="item.pic == 3"
              />
              <img
                src="../../assets/user4.png"
                alt
                style="width:20px;height:20px;"
                v-else-if="item.pic == 4"
              />
              <img
                src="../../assets/user5.png"
                alt
                style="width:20px;height:20px;"
                v-else-if="item.pic == 5"
              />
              <img
                src="../../assets/user6.png"
                alt
                style="width:20px;height:20px;"
                v-else-if="item.pic == 6"
              />
              <span v-else class="no-pic" style="min-width:20px;min-height:20px;border-radius:50%;"></span>
    ...
    >
      ...
      <div class="popup">
        ...
        <div class="option">
          ...
          <div class="normal" v-if="memberInfo.mobile">
            {{ memberInfo.mobile }}
          </div>
        ...
        <div class="option">
          ...
          <div class="normal" v-if="memberInfo.email">
            {{ memberInfo.email }}
          </div>
          <div class="normal" v-else>--</div>
        </div>
    ...
    >
      <div class="popup">
        ...
        <div class="scess">
          <a-divider />
          <div class="url">{{ inviteUrl }}<a-icon type="sync" class="reflash" @click="urlChange"/></div>
