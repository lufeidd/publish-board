            ...
            <div class="model-container">
              <div class="model-bg search">
                ...
                <div class="content common" style="position:relative;">
                  ...
                  <div class="search-result" v-if="showResult">
                    <div class="list" v-if="dataSource.length > 0">
                      ...
                      >
                        <img :src="item1.photo" alt width="35px" height="35px" style="width:35px;height:35px;" v-if="item1.photo" />
                ...
                <div class="history" v-if="historyList.length > 0">
                  ...
                  >
                    <div>
                      <img :src="item.photo" alt width="100px" height="100px" style="width:100px;height:100px;" v-if="item.photo" />
                      ...
                      <tr v-for="(item,index) in authorList" :key="index">
                        <td>
                          <div class="goods-desc">
                            <img :src="item.photo" alt width="40px" height="40px" style="width:80px;height:80px;" v-if="item.photo" />
