    ...
    <div class="wd-1220">
      <div class="clearfix">
        <div class="float-left">
          <SlideNav type="industry" sort="region"></SlideNav>
        </div>
        <div class="float-right">
          <div class="main-container" v-if="pagePower">
                    ...
                    <div class="container">
                      <div class="content">
                        ...
                        <p class="desc">
                          ...
                          <span v-else>--</span>
                          <span class="text red" v-if="incrTop.compare_rate > 0"
                      ...
                      <div class="content">
                        ...
                        <p class="desc">
                          <span v-if="readerTop.name">{{
                            readerTop.name
                          }}</span>
                          <span v-else>--</span>
                          <span class="text" v-if="readerTop.reader_total">{{
                            readerTop.reader_total
                          }}</span>
            ...
            <div class="model-container">
              <div
                class="model-bg"
                style="min-height: 254px; padding-bottom: 20px"
              >
                    ...
                    <tbody v-if="list.length > 0">
                      <tr v-for="(item, index) in list" :key="index">
                        ...
                        <td style="text-align: right">
                          ...
                          >
                          <span class="green" v-elseif="item.compare_rate < 0"
                            >{{ item.compare_rate }}%</span
                          >
                        </td>
                        <td
                        ...
                        >
                          较上期排名上升 {{ item.rank_compare * -1 }} 名
                        </td>
                        <td
                          style="text-align: right"
                          v-if="item.rank_compare > 0"
                        >
                          较上期排名下降 {{ item.rank_compare }} 名
                        </td>
                        <td
                          style="text-align: right"
                          v-if="item.rank_compare == 0"
...
<script>
import { INDUSTRY_RANK_REGION } from "../../apis/industry.js";
...
export default {
  ...
  methods: {
    async getData() {
      ...
      let res = await INDUSTRY_RANK_REGION(data);
      if (res.code == 0) {
        this.pagePower = true;
        this.list = [];
