              ...
              <div class="model-bg">
                <div class="section-title clearfix">
                  ...
                  <div class="float-right" style="font-weight:normal;">
                    <a-radio-group name="radioGroup" v-model="cateRadio" @change="cateChange">
                      <a-radio :value="1" style="font-size:12px;">堆积图</a-radio>
                      <a-radio :value="2" style="font-size:12px;">对比图</a-radio>
                    </a-radio-group>
                  </div>
                </div>
                <div>
            ...
            <div class="model-container">
              <div class="model-bg">
                <div class="section-title clearfix">
                  <div class="float-left">类目对比</div>
                  <div class="float-right" style="font-weight:normal;">
                    <a-radio-group name="radioGroup" v-model="regionRadio" @change="regionChange">
                      <a-radio :value="1" style="font-size:12px;">堆积图</a-radio>
                      <a-radio :value="2" style="font-size:12px;">对比图</a-radio>
                    </a-radio-group>
                  </div>
