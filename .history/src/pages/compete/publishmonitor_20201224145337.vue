...
export default {
  ...
  methods: {
    ...
    async getCate(){
      ...
      if(res.code == 0){
        ...
        if(this.cateFirst){
          ...
          // this.stackingChart1.destroy();
          // this.contrastChart1.destroy();
          // this.initStacking1();
          // this.initContrast1();
        }
      }else{
    ...
    initStacking1() {
      ...
      this.stackingChart1.data(this.cateList);
      ...
      this.stackingChart1
        ...
        .color("type*name", (type, name) => {
          ...
          _this.list.map((val,index)=>{
            ...
            }else if(val.supplier_id == _this.publishId1)
          })
