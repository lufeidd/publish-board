...
export default {
  ...
  methods: {
    ...
    goodsArr(){
      this.allGoodsList = [];
      this.allGoodsList.push(this.publishList1);
      if(this.publishList2.length > 0){
        this.allGoodsList.push(this.publishList2);
      }
      if(this.publishList3.length > 0){
        this.allGoodsList.push(this.publishList3);
      }
      if(this.publishList4.length > 0){
        this.allGoodsList.push(this.publishList4);
      }
      console.log()
    },
    cateChange(e) {},
