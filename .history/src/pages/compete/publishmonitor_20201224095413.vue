            ...
            <div class="model-container">
              <div class="model-bg">
                ...
                <div class="goods-compare">
                  ...
                  >
                    <div
                      :class="index == 0?'table float-left':'table float-right'"
                      style="width: 520px"
                      ...
                      <table style="table-layout: fixed">
                        ...
                        <tbody>
                          <tr v-for="(litem, lindex) in item.arr" :key="lindex">
                            <td>
                              <div class="goods-desc">
                                <span class="goods-image" v-if="litem.cover_pic">
                                  <img
                                    :src="litem.cover_pic"
                                    alt
                                    style="width: 40px; height: 40px"
                  ...
                  <div
                    ...
                    style="margin-top: 10px"
                  >
                    <div class="table float-left" style="width: 360px" v-for="(item,index) in allGoodsList" :key="index">
                      <table style="table-layout: fixed">
                        <colgroup>
                          <col width="220" />
                          <col width="140" />
                        ...
                        <tbody>
                          <tr v-for="(litem,lindex) in item.arr" :key="lindex">
                            ...
                            <td style="text-align: right">
                              <span class="main-font">{{litem.sale_total}}</span>
                            </td>
                          </tr>
                        </tbody>
                      </table>
                  ...
                  <div
                    ...
                    style="margin-top: 10px"
                  >
                    <div class="table float-left" style="width: 270px" v-for="(item,index) in allGoodsList" :key="index">
                      <table style="table-layout: fixed">
                        <colgroup>
                          <col width="150" />
                          <col width="80" />
                        ...
                        <thead>
                          <tr>
                            ...
                            <td style="text-align: right;white-space:nowrap;">销售指数</td>
                          </tr>
                        </thead>
                        <tbody v-if="item.arr.length ">
                          <tr v-for="(litem,lindex) in item.arr" :key="lindex">
                            <td>
                              <div class="goods-desc">
                                <span class="goods-image" v-if="litem.cover_pic">
