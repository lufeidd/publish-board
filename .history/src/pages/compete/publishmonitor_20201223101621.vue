            ...
            <div class="model-container">
              <div class="model-bg">
                ...
                <div class="goods-compare">
                  <div class="table" v-if="selectList.length == 0" style="margin-top:10px;">
                      ...
                      <thead>
                        <tr>
                          <td>
                            ...
                            <span class="main-font" style="display:inline-block;vertical-align:middle;margin-left:10px;">浙江摄影</span>
                          </td>
                  ...
                  <div class="clearfix" v-if="selectList.length == 1" style="margin-top:10px;">
                    <div class="table float-left" style="width:485px;"></div>
                  </div>
                </div>
              </div>
            </div>
