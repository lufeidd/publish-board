              ...
              <div class="model-bg">
                ...
                <div class="goods-compare">
                  ...
                  <div
                    ...
                    style="margin-top: 10px"
                  >
                    <div class="table float-left" style="width: 520px" v-for="(item,index) in allGoodsList" :key="index">
                      <table style="table-layout: fixed">
                        <colgroup>
                          <col width="360" />
                          <col width="160" />
                        ...
                        <tbody>
                          <tr v-for="(litem,lindex) in item" :key="lindex">
                            <td>
...
export default {
  ...
  methods: {
    ...
    goodsArr(){
      this.allGoodsList = [];
      this.allGoodsList.push(this.goodsList1);
      if(this.goodsList2.length > 0){
        this.allGoodsList.push(this.goodsList2);
      }
      if(this.goodsList3.length > 0){
        this.allGoodsList.push(this.goodsList3);
      }
      if(this.goodsList4.length > 0){
        this.allGoodsList.push(this.goodsList4);
      }
