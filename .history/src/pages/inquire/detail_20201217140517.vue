      ...
      <div class="clearfix">
        ...
        <div class="float-right">
          <div class="main-container">
              ...
              >
                ...
                <div class="tabs">
                  <a-tabs :activeKey="tabKey" @change="callback">
                    <a-tab-pane key="1" tab="销售zoushi"></a-tab-pane>
                    <a-tab-pane key="1" tab="品种列表"></a-tab-pane>
                    <a-tab-pane key="2" tab="核心类目"></a-tab-pane>
            ...
            <!-- 核心类目无权限 -->
            <div class="model-container" v-if="tabKey == '2' && !catePower">
              <div class="model-bg">
                <div class="section-title">核心类目</div>
                <div style="height: 287px; position: relative">
                  <div
            ...
            <!-- 读者画像无权限 -->
            <div class="model-container" v-if="tabKey == '3' && !readerPower">
              <div class="model-bg">
