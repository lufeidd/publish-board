                  ...
                  <div class="goods-list clearfix">
                    <div class="float-left">
                      <div class="goods">
                        ...
                        <span
                          class="data-tab data-tab-three data-tab-click"
                          v-if="item.trend == 1"
                          >逐步下降
                        </span>
                        <span
                          class="data-tab data-tab-two data-tab-click"
                          v-if="item.trend == 2"
                          >持续增长
                        </span>
                        <span
                    ...
                    <div class="float-right">
                      <div class="data-block">
                        ...
                        <div class="font" v-if="item.publish_duration > 0">
                          {{ item.publish_duration }}个月
                        </div>
