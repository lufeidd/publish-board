                  ...
                  <div class="goods-desc">
                    <div style="height:67px;">
                      ...
                      <div style="padding-top:3px;">
                        <span v-if="goodsInfo.is_presale == 1" class="data-tab data-tab-one" style="margin:0;color:#1754D2;">预售品种</span>
                        <span v-else-if="goodsInfo.have_presale == 1" class="data-tab data-tab-seven" style="margin:0;">组套品种</span>
                        <span v-if="goodsInfo.best_rank_info" class="data-tab data-tab-seven" style="margin:0;">{{goodsInfo.best_rank_info}}</span>
                      </div>
                    </div>
                    <div class="isbn">
                      <span>ISBN</span>
              ...
              <div v-if="salePower">
                ...
                <div class="content model-bg">
                  ...
                  <div style="margin-top: 20px">
                    <div id="broken-line1" v-if="brokenLineData1.length > 0"></div>
                  </div>
                </div>
              </div>
              <div
  ...
  methods: {
    ...
    async getCoreData() {
      ...
      if (res.code == 0) {
        ...
        if(this.brokenLineData1.length ){
