      ...
      <div class="clearfix">
        ...
        <div class="float-right">
          <div class="main-container" v-if="pagePower">
            <a-date-picker :allowClear="false" format="MM-DD" />
              ...
              <td>
                <div class="goods-desc">
                  <span class="goods-image" v-if="item.cover_pic">
                    ...
                    />
                    <div class="goods-logo prev" v-if="item.is_presale == 1">
                      预
                    </div>
                    <div
  ...
  methods: {
    ...
    openPopup(item, index) {
      if (item.parents.length > 0) {
        this.popupName = item.parents.join(">") + ">" + item.category_name;
      } else {
        this.popupName = item.category_name;
      }
      this.getGoodsList(item.category_id);
    },
    changeTime() {
      this.isLoading = true;
      this.page = 1;
