                      ...
                      <tr v-for="(item,index) in list" :key="index">
                        ...
                        <td style="text-align:right;">
                          <span v-if="item.memo.goods_nums">
                            有{{item.memo.goods_nums}}个品种进入类目前100<br><span @click="$toDetail(item.memo.goods_id)" class="click-font">《{{item.memo.goods_name}}》</span>排名第{{item.memo.goods_rank}}位
                          </span>
                          <span v-else>--</span>
                        </td>
                      </tr>
                  ...
                  <table style="table-layout:fixed;" v-else>
                    ...
                    <tbody v-if="list.length > 0">
                      <tr v-for="(item,index) in list" :key="index">
                        ...
                        <td style="text-align:right;">
                          <span v-if="item.memo.goods_nums">
                            有{{item.memo.goods_nums}}个品种进入类目前100<<span @click="$toDetail(item.memo.goods_id)" class="click-font">《{{item.memo.goods_name}}》</span>排名第{{item.memo.goods_rank}}位
                          </span>
                          <span v-else>--</span>
                        </td>
                      </tr>
