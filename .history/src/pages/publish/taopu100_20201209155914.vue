                  ...
                  <table style="table-layout: fixed">
                    ...
                    <tbody>
                      <tr v-for="(item, index) in goodsList" :key="index">
                        ...
                        <td>
                          <span v-if="item.cate_node_2">{{ item.cate_node_2 }}</span>
                          <span v-if="item.cate_node_3">＞ {{ item.cate_node_3 }}</span>
                        </td>
