                  ...
                  <div class="goods-list clearfix">
                    <div class="float-left">
                      <div class="goods">
                        ...
                        <span class="data-tab data-tab-three data-tab-click" v-if="item.trend == 2">逐步下降
                        </span>
                        <span class="data-tab data-tab-two data-tab-click" v-if="item.trend == 1">持续增长
                        </span>
                        <span class="data-tab data-tab-two data-tab-click" v-if="item.trend == 3">平稳销售
                        </span>
