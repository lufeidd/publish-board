            ...
            <div v-if="measurePower">
              <div style="padding: 15px" class="clearfix">
                ...
                >
                  ...
                  <div class="before">
                    <span>同时段对比</span>
                    <span class="num red" v-if="publishData.compare_rate > 0">+{{ publishData.compare_rate }}%</span>
                    <span class="num green" v-else-if="publishData.compare_rate <= 0">{{ publishData.compare_rate }}%</span>
                ...
                >
                  ...
                  <div class="before">
                    <span>同时段对比</span>
                    <span class="num red" v-if="allData.compare_rate > 0">+{{allData.compare_rate}}%</span>
                    <span class="num green" v-else-if="allData.compare_rate <= 0">{{allData.compare_rate}}%</span>
                    <span class="num" v-else>--</span>
                  </div>
                </div>
              </div>
        ...
        <div class="impend-event float-right">
          ...
          <div class="model-bg">
            <div class="section-title clearfix">
              ...
              <span class="click-font float-right" @click="$router.push({ name: 'applicationevent' })">前往事件年历</span>
            </div>
            <div class="animation">
      ...
      <div class="model-container clearfix">
        ...
        <div class="float-left sale-rank model-bg">
          <div class="section-title clearfix">
            ...
            <span class="click-font float-right" @click="$router.push({name:'taopu100',query:{sort:'rank_supplier'}})"
              >前往完整排行</span
            >
          </div>
        ...
        <div class="float-left up-rank model-bg">
          <div class="section-title clearfix">
            ...
            <span class="click-font float-right" @click="$router.push({name:'taopu100',query:{sort:'rank_incr_supplier'}})"
              >前往完整排行</span
            >
          </div>
          <div class="table-data" v-if="dataRankPower">
        ...
        <div class="float-left new-rank model-bg">
          <div class="section-title clearfix">
            ...
            <span class="click-font float-right" @click="$router.push({name:'taopu100',query:{sort:'rank_new_supplier'}})"
              >前往完整排行</span
            >
          </div>
          <div class="table-data" v-if="dataRankPower">
