<template>
  <div id="slideNav">
    <div class="top-container">
      ...
      <div class="slide-desc" v-if="type == 'actual'">
        <img src="../assets/publish.png" alt  style="width:50px;height:50px;" />
      ...
      <div class="slide-content" v-if="type == 'actual'">
        <div :class="sort=='board'?'active tab':'tab'" @click.stop="$router.push({ name: 'actualboard' })">实时看板</div>
      </div>
      <div class="slide-content" v-if="type == 'admin'">
        ...
        <router-link to="/admin/accessdata">
          <div :class="sort=='adminAccess'?'active tab':'tab'">意见与反馈</div>
        </router-link>
      ...
      <div class="slide-content" v-if="type == 'inquire'">
        ...
        <div :class="sort=='goods'?'active tab':'tab'" @click.stop="$router.push({ name: 'inquiregoodslist' })">品种查询</div>
      </div>
